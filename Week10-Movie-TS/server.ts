...
// 회원가입
app.post('/auth/register', (req: Request<{}, {}, { email: string; password: string; passwordCheck: string }>, res: Response) => {
...
// 로그인
app.post('/auth/login', (req: Request<{}, {}, { email: string; password: string }>, res: Response) => {
...
// 토큰 갱신
app.post('/auth/token/access', (req: Request, res: Response) => {
  const authHeader = req.headers.authorization;
  if (authHeader && authHeader.startsWith('Bearer ')) {
