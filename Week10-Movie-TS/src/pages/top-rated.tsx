...
// 높은 평가를 받은 영화 데이터 가져오기
const fetchTopRatedMovies = (page: number): Promise<MoviesResponse> =>
  axiosInstance.get(`/movie/top_rated?language=ko-KR&page=${page}`).then((res) => res.data);
