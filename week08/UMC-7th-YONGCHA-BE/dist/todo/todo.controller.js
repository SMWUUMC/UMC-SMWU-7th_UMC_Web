...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        description: '[Todo]를 조회하는 API, query-parameter를 넘길 경우, 해당 title에 대응하는, todo 목록을 줍니다. ',
    }),
    (0, swagger_1.ApiOkResponse)(),
    (0, swagger_1.ApiQuery)({ name: 'title', required: false, description: 'Todo 제목 입력' }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: require("./entity/todo.entity").Todo }),
