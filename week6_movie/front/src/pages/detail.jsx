...
const MovieDetail = () => {
  ...
  useEffect(() => {
    const fetchMovieDetail = async () => {
      try {
        const movieResponse = await axiosInstance.get(`/movie/${movieId}?language=ko-KO`);
        setMovie(movieResponse.data);

        const castResponse = await axiosInstance.get(`/movie/${movieId}/credits?language=ko-KO`);
